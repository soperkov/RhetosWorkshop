...
* Basic concepts: ReportData and ReportFile
  * Examples in unit tests [Computations.rhe](https://github.com/Rhetos/Rhetos/blob/master/test/CommonConcepts.TestApp.Shared/DslScripts/Computations.rhe)
...
* [SqlObject](https://github.com/Rhetos/Rhetos/wiki/SqlObject-concept),
  ...
  * Example in unit test
    [FullTextSearchTest.rhe](https://github.com/Rhetos/Rhetos/blob/master/test/CommonConcepts.TestApp.Shared/DslScripts/FullTextSearchTest.rhe)
